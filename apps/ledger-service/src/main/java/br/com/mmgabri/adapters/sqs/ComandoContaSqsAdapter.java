...
import br.com.mmgabri.services.ComandoContaService;
...
public class ComandoContaSqsAdapter implements SmartLifecycle {
    ...
    private final ComandoContaService comandoContaService;
    ...
    private void processMessage(Message message) {
        ...
        try {
            metricsService.incrementMetricCounter("app_ledger_msg_received_autorizador");
            ...
            comandoContaService.execute(request);
            ...
            metricsService.incrementMetric("app_ledger_duration_transaction", startTime, "method:processMessage");
