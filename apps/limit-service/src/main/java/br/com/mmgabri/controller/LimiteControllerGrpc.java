...
public class LimiteControllerGrpc extends LimiteServiceGrpc.LimiteServiceImplBase {

    private static final Logger logger = LoggerFactory.getLogger(LimiteControllerGrpc.class);
    ...
    public void atualizarLimite(LimiteRequest request, StreamObserver<LimiteResponse> responseObserver) {
        ...
        logger.info("Received atualizarLimite");
        try {
