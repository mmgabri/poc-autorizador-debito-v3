 ...
 * <p>
 * PENDING e TIMEOUT são escritos pelo autorizador; COMPLETED é escrito pelo
 * ledger-service; COMPLETED_LATE pode ser escrito por qualquer um dos dois,
 * dependendo de quem perde a corrida (ver {@link ComandoContaTransition} e
 * {@link ComandoContaEvent}).
 */
@Getter
